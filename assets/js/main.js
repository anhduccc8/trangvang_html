...
$(document).ready(function() {
    $('.section-product .owl-carousel').owlCarousel({
        ...
        margin: 34,
        navText: [
            '<a href="javascript:;" class="owl_next prev_owl"><img src="./image/left.svg" alt="left"></a>',
            '<a href="javascript:;" class="owl_prev next_owl"><img src="./image/next.svg" alt="right"></a>'
        ],
        responsive: {
            0: {
                items: 1
